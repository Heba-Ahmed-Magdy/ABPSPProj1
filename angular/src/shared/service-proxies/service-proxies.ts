...
export class DepartmentServiceProxy {
    ...
    /**
     * @param filteringString (optional) 
     * @param sorting (optional) 
     * @param skipCount (optional) 
     * @param maxResultCount (optional) 
     * @return Success
     */
    getAllFiltered(filteringString: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfDepartmentDto> {
        let url_ = this.baseUrl + "/api/services/app/Department/GetAllFilteredAsync?";
        if (filteringString !== undefined)
            url_ += "FilteringString=" + encodeURIComponent("" + filteringString) + "&"; 
    ...
    protected processGetAllFiltered(response: HttpResponseBase): Observable<PagedResultDtoOfDepartmentDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    get(id: string | null | undefined): Observable<DepartmentDto> {
     ...
     * @return Success
     */
    getAll(skipCount: number | null | undefined, maxResultCount: number | null | undefined, sorting: string | null | undefined): Observable<PagedResultDtoOfDepartmentDto> {
...
export class EmployeeServiceProxy {
     ...
     * @return Success
     */
    getAllFiltered(filteringString: string | null | undefined, sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfEmployeeDto> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetAllFilteredAsync?";
        if (filteringString !== undefined)
            url_ += "FilteringString=" + encodeURIComponent("" + filteringString) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
    ...
    protected processGetAllFiltered(response: HttpResponseBase): Observable<PagedResultDtoOfEmployeeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getEmployeesLength(): Observable<number> {
        let url_ = this.baseUrl + "/api/services/app/Employee/GetEmployeesLength";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetEmployeesLength(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetEmployeesLength(<any>response_);
                } catch (e) {
    ...
    protected processGetEmployeesLength(response: HttpResponseBase): Observable<number> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    hardDel(x: string | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Employee/hardDel?";
        if (x !== undefined)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processHardDel(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processHardDel(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processHardDel(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    delUpd(input: EmployeeDto | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Employee/delUpd";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDelUpd(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDelUpd(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDelUpd(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(skipCount: number | null | undefined, maxResultCount: number | null | undefined, sorting: string | null | undefined): Observable<PagedResultDtoOfEmployeeDto> {
...
export class ServiceProxy {
     ...
     * @return Success
     */
    employees(): Observable<PagedResultDtoOfEmployeeDto> {
    ...
    protected processEmployees(response: HttpResponseBase): Observable<PagedResultDtoOfEmployeeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
